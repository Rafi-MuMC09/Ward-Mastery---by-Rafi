...
const GENERAL_EXAM_DATA = {
        ...
        subtypes: {
            "Anaemia": {
                ...
                site: [
                    {
                        text: "Lower palpebral conjunctiva (most reliable — retract with thumbs, patient looks up)",
                        media: [{ type: "image", url: "https://raw.githubusercontent.com/Rafi-MuMC09/Ward-Mastery---by-Rafi/main/images/general-exam/anemia-conjunctiva.jpg", caption: "Q. Look at the ceiling" }]
                    },
                    {
                        text: "Dorsal surface of tongue & mucous membrane of oral cavity (yellowish pallor)",
                        media: [{ type: "image", url: "https://raw.githubusercontent.com/Rafi-MuMC09/Ward-Mastery---by-Rafi/main/images/general-exam/anemia-tongue.jpg", caption: "Q. Show your tongue" }]
                    },
                    {
                        text: "Palm of the hands — nail beds, lips & whole body",
                        media: [{ type: "image", url: "https://raw.githubusercontent.com/Rafi-MuMC09/Ward-Mastery---by-Rafi/main/images/general-exam/anemia-palm.jpg", caption: "Q. Show your palm of the hands" }]
                    },
                    { text: "Palms and soles" },
                    { text: "Oral mucosa and soft palate" }
                ],
                types: [
