...
// Base path for CVS examination images (uploaded to images/systemicinquiry/cvs/ in the repo).
// Using a relative path assumes this folder sits at the site root alongside index.html
// (true for a standard GitHub Pages deploy). If your images live elsewhere (e.g. you serve
// from a different host or sub-path), just change this one constant.
const CVS_IMG_BASE = "images/systemicinquiry/cvs/";
                ...
                clinicalExamNotes: [
                    ...
                    },
                    {
                        ...
                        points: [
                            ...
                            "── PALPATION TECHNIQUE (sequence) ──",
                            {
                                ...
                                media: [{ type: "image", url: CVS_IMG_BASE + "Apexbeat-supine.jpg", caption: "Initial flat-hand palpation, patient supine/reclined at 45°" }]
                            },
                            {
                                text: "Step 2: Lay fingers PARALLEL to rib spaces → locate most inferior and lateral point of impulse = Apex Beat",
                                media: [{ type: "image", url: CVS_IMG_BASE + "Apexbeatpoint.jpg", caption: "Locating the apex beat with fingers parallel to the rib spaces" }]
                            },
                            "If apex not palpable: roll patient onto LEFT SIDE (left lateral position) — brings apex closer to chest wall",
                            {
                                ...
                                media: [{ type: "image", url: CVS_IMG_BASE + "Heave.jpg", caption: "Heel of hand over left parasternal area, assessing for RV heave" }]
                            },
                            {
                                text: "Step 4: Palpate for THRILLS at apex and on both sides of sternum using flat of fingers",
                                media: [{ type: "image", url: CVS_IMG_BASE + "Thrill-mitral.jpg", caption: "Palpating for a thrill at the apex (mitral area)" }]
                            },
                            {
                                text: "Subxiphoid/epigastric palpation: place fingertips in the epigastrium angled up under the costal margin, breath held in inspiration — pulsation here may represent an RV heave (sometimes felt better here than at the left sternal edge in a hyperinflated chest) or an expansile abdominal aortic pulsation",
                                media: [{ type: "image", url: CVS_IMG_BASE + "Epigastrium-pulsation.jpg", caption: "Epigastric/subxiphoid palpation technique" }]
                            },
                            "── AREA 1: MITRAL AREA (Apex) — 5th ICS, mid-clavicular line ──",
                            {
                                text: "Location: 5th left intercostal space at or just medial to the mid-clavicular line",
                                media: [{ type: "image", url: CVS_IMG_BASE + "Apexbeatarea.jpg", caption: "Mitral area / normal apex beat location — 5th left ICS, mid-clavicular line" }]
                            },
                            ...
                            {
                                text: "Displaced laterally (anterior/mid-axillary line, 6th–7th ICS) → LV dilatation: heart failure, severe AR",
                                media: [{ type: "image", url: CVS_IMG_BASE + "Apexbeat-axilla.jpg", caption: "Displaced apex beat — palpating towards the axilla" }]
                            },
                            ...
                            "RV heave (lifts heel of hand) → RV hypertrophy / dilatation: pulmonary hypertension, ASD, tricuspid regurgitation",
                            {
                                ...
                                media: [{ type: "image", url: CVS_IMG_BASE + "Thrill-tricuspid.jpg", caption: "Palpating for a thrill at the tricuspid area" }]
                            },
                            ...
                            "Location: 2nd left intercostal space, left sternal border",
                            {
                                ...
                                media: [{ type: "image", url: CVS_IMG_BASE + "Thrill-pulmonary.jpg", caption: "Palpating for a thrill at the pulmonary area" }]
                            },
                            "Thrill here → Pulmonary Stenosis",
                            {
                                text: "Palpable P2 (loud pulmonary component of S2) → Pulmonary Hypertension",
                                media: [{ type: "image", url: CVS_IMG_BASE + "Palpable-p2.jpg", caption: "Palpating for P2 at the pulmonary area" }]
                            },
                            "── AREA 4: AORTIC AREA — 2nd ICS, right sternal border ──",
                            "Location: 2nd right intercostal space, right sternal border",
                            {
                                text: "Palpate with flat of fingers for thrills",
                                media: [{ type: "image", url: CVS_IMG_BASE + "Thrill-aortic.jpg", caption: "Palpating for a thrill at the aortic area" }]
                            },
                            ...
                            {
                                text: "Palpable A2 (forceful aortic valve closure felt as a tap in the aortic area) → systemic hypertension, hyperdynamic circulation",
                                media: [{ type: "image", url: CVS_IMG_BASE + "Palpable-A2.jpg", caption: "Palpating for A2 at the aortic area" }]
                            },
                            "── DEXTROCARDIA ──",
                    ...
                    },
                    {
                        ...
                        points: [
                            ...
                            "── AREA 1: MITRAL AREA (Apex) — 5th ICS, mid-clavicular line ──",
                            {
                                text: "Location: 5th left ICS at mid-clavicular line",
                                media: [{ type: "image", url: CVS_IMG_BASE + "Auscultation-mitral.jpg", caption: "Auscultating the mitral area" }]
                            },
                            ...
                            {
                                text: "Location: 4th left intercostal space, lower left sternal border",
                                media: [{ type: "image", url: CVS_IMG_BASE + "Auscultation-tricuspid.jpg", caption: "Auscultating the tricuspid area" }]
                            },
                            ...
                            "── AREA 3: PULMONARY AREA — 2nd ICS, left sternal border ──",
                            {
                                text: "Location: 2nd left intercostal space, left sternal border",
                                media: [{ type: "image", url: CVS_IMG_BASE + "Auscultation-pulmonary.jpg", caption: "Auscultating the pulmonary area" }]
                            },
                            ...
                            "── AREA 4: AORTIC AREA — 2nd ICS, right sternal border ──",
                            {
                                text: "Location: 2nd right intercostal space, right sternal border",
                                media: [{ type: "image", url: CVS_IMG_BASE + "Auscultation-aortic.jpg", caption: "Auscultating the aortic area" }]
                            },
