    ...
    "systemic_inquiry": {
        ...
        subtypes: {
            ...
            "Cardiovascular System": {
                ...
                clinicalExamNotes: [
                    {
                        title: "Arterial Pulse — Rate, Rhythm, Volume & Character (Macleod's)",
                        points: [
                            "Assess 4 things at the pulse: Rate · Rhythm · Volume · Character",
                            "Radial pulse (rate & rhythm): Place pads of index + middle fingers just lateral to flexor carpi radialis tendon at the wrist. Count for 15 seconds × 4 = rate in bpm. Normal resting rate: 50–95 bpm",
                            "Bradycardia = <60 bpm | Tachycardia = >100 bpm",
                            "Rhythm: Regular (sinus rhythm) | Regularly irregular (ectopics, 2nd degree block) | Irregularly irregular = Atrial Fibrillation — no pattern at all",
                            "Pulse deficit in AF: apical rate > radial rate — some beats too weak to reach the wrist",
                            "Brachial pulse (volume & character): Cup hand under patient's elbow, use thumb to palpate in antecubital fossa just medial to biceps tendon. Use right thumb for patient's right arm, left thumb for left arm",
                            "Carotid pulse (best for character): Place fingertips between larynx and anterior border of sternocleidomastoid. Palpate gently — avoid vagal reflex. NEVER palpate both carotids simultaneously",
                            "Coincidence with carotid pulse: S1 (first heart sound) occurs just BEFORE the upstroke of the carotid pulse — use this to time heart sounds during auscultation",
                            "Collapsing pulse test (for AR): Check no shoulder pain first. Feel pulse with base of fingers then raise patient's arm vertically above head — a slapping water-hammer sensation = collapsing pulse",
                            "Radio-femoral delay: Feel radial and femoral pulses simultaneously — radial felt before femoral = Coarctation of Aorta"
                        ]
                    },
                    {
                        title: "Pulse Character — Types & Clinical Meaning (Macleod's)",
                        points: [
                            "Slow-rising pulse: Gradual upstroke, reduced peak occurring late in systole → Severe Aortic Stenosis",
                            ...
                            "Pulsus paradoxus: Pulse volume falls or disappears on inspiration (>10 mmHg drop in systolic BP on inspiration) → Cardiac Tamponade; also severe asthma, pericardial constriction",
                            "Pulsus alternans: Alternating strong and weak beats with regular rhythm → Severe LV failure",
                            "Pulsus bisferiens (Jerky/Bifid): Double systolic peak separated by mid-systolic dip → Combined AS + AR, or HOCM",
                    ...
                    {
                        title: "Precordium — Inspection & Palpation (Macleod's)",
                        points: [
                            ...
                            "Palpation step 1: Place right hand flat over precordium — get general impression of cardiac impulse",
                            "Palpation step 2: Lay fingers parallel to rib spaces → locate most inferior and lateral point of impulse = Apex Beat",
                            "If apex not palpable: ask patient to roll onto LEFT SIDE (left lateral position) — brings apex closer to chest wall",
                            "Count intercostal spaces from 2nd ICS (just below sternal angle) downward to locate apex position",
                            "Normal apex: 5th left ICS at or just medial to mid-clavicular line — brief localised lift of fingers",
                            "Displaced apex (laterally): LV dilatation — heart failure, severe AR",
                            "Heaving / sustained apex (not displaced): LV hypertrophy — hypertension, severe AS",
                            "Tapping apex (not displaced — palpable S1): Mitral Stenosis",
                            "Impalpable apex: Obesity, COPD (hyperinflation), pericardial effusion",
                            "RV heave: Apply heel of right hand firmly to left parasternal area, patient holds breath in expiration — lifting sensation = RV hypertrophy / pulmonary HTN",
                            "Thrill (palpable murmur, like cat purring): Most common = aortic area thrill → Aortic Stenosis"
                        ]
                    },
                    {
                        title: "Auscultation — Sequence, Heart Sounds & Added Sounds (Macleod's)",
                        points: [
                            "Diaphragm = high-frequency sounds: S1, S2, AR murmur, ejection systolic murmur",
                            "Bell (light pressure) = low-frequency sounds: S3, S4, Mitral Stenosis mid-diastolic murmur",
                            "Identify S1 and S2: Palpate carotid simultaneously — S1 just BEFORE carotid upstroke | S2 just AFTER. Systole = S1 to S2 | Diastole = S2 to next S1",
                            "Auscultation sequence with diaphragm: Apex → Lower left sternal border → Upper right sternal border → Upper left sternal border → Carotids → Left axilla. Then repeat with bell at apex and lower left sternal border",
                            "Special position 1 — Left lateral + bell at apex (light pressure): to hear Mitral Stenosis mid-diastolic rumble (accentuated by exercise)",
                            "Special position 2 — Sitting forward, breath held in full expiration + diaphragm at left sternal edge: to hear Aortic Regurgitation early diastolic murmur",
                            "S1 (lub): Closure of mitral + tricuspid at onset of systole. Best at apex. Loud S1 → Mitral Stenosis. Soft S1 → poor LV function",
                            "S2 (dub): Closure of aortic + pulmonary at end of systole. Best at left sternal edge. Splits on inspiration (physiological). Fixed split → ASD. Loud P2 → Pulmonary HTN",
                            "S3 (early diastolic, after S2): Low-pitched, bell at apex — rapid ventricular filling. After age 40 = LV failure or MR (gallop rhythm with tachycardia)",
                            "S4 (pre-systolic, before S1): Soft, low-pitched, bell at apex — forceful atrial contraction against stiff LV. Causes: LVH from HTN, AS, HOCM. Absent in AF",
                            "Opening Snap: High-pitched, early diastole just after S2, diaphragm at apex → Mitral Stenosis",
                            "Ejection Click: Early systole just after S1 → Congenital AS or PS (bicuspid valve). Absent in calcific AS",
                            "Pericardial Rub: Coarse scratching, biphasic, diaphragm, breath held in expiration → Pericarditis"
                        ]
                    },
                    {
