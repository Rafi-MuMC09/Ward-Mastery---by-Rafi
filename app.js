...
function renderPediatrics(group) {
    ...
    // Toggle active state on the two top buttons
    const btnYoung = document.getElementById("peds-tab-young");
    const btnChild = document.getElementById("peds-tab-child");
    if (btnYoung && btnChild) {
        btnYoung.classList.toggle("active", group === "youngInfant");
        btnChild.classList.toggle("active", group === "child");
    }
...
// Auto-render Child group by default when Pediatrics tab is first opened
document.addEventListener("DOMContentLoaded", function() {
    const pedsSection = document.getElementById("peds");
    if (pedsSection && typeof PEDIATRICS_DATA !== "undefined") {
        renderPediatrics("child");
    }
});
